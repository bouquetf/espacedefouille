...
// Deployment settings.
s3_bucket = "www.espacedefouille.org"
...
// General settings.
title = 'Espace de fouille' // blog name for the header, title and RSS feed
subtitle = 'La zone de fouille technologique autour de la JVM' // blog brief description for the header
author = 'Frédéric Bouquet'                 // author name for Copyright, Metadata and RSS feed
...
disqus {
    short_name = 'bouquetf'                 // the unique identifier assigned to a Disqus (http://disqus.com/) forum
}
...
default_asides = ['asides/recent_posts.html', 'asides/github.html', 'asides/tweets.html',
        'asides/about.html', 'asides/twitter.html', 'asides/google_plus.html']
...
//    }
    ...
    // GitHub repositories.
    github {
        user = 'bouquetf'           // GitHub (https://github.com/) username
    ...
    // The latest tweets.
    tweets {
        user = 'bouquetf'           // Twitter (https://twitter.com/) username
    ...
    google_plus {
        user = '115349045793242426218' // Google plus (https://plus.google.com/) user id
    }
    twitter {
        user = 'bouquetf'           // Twitter (https://twitter.com/) username
    }
...
//    }
    ...
    about_author = 'Enthousiaste et évengéliste Open Source';
